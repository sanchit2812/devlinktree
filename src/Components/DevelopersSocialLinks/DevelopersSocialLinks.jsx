...
function DevelopersSocialLinks(props) {
    ...
    return (
        <div className="developers-social-social-links">
            <a href={`https://github.com/${developer.githubId}`} target="blank">
                <img className="developers-social-social-element" src={githubIcon} alt="" />
            </a>
            {developer.hackerrankId && (
                <a href={`https://www.hackerrank.com/${developer.hackerrankId}`} target="blank">
                    <img className="developers-social-social-element" src={hackerrankIcon} alt="" />
                </a>
            )}
            {developer.codechefId && (
                <a href={`https://www.codechef.com/users/${developer.codechefId}`} target="blank">
                    <img className="developers-social-social-element" src={codechefIcon} alt="" />
                </a>
            )}
            {developer.linkedinId && (
                <a href={`https://www.linkedin.com/in/${developer.linkedinId}`} target="blank">
                    <img className="developers-social-social-element" src={linkedinIcon} alt="" />
                </a>
            )}
            {developer.mediumId && (
                <a href={`https://medium.com/@${developer.mediumId}`} target="blank">
                    <img className="developers-social-social-element" src={mediumIcon} alt="" />
                </a>
            )}
            {developer.twitterId && (
                <a href={`https://twitter.com/${developer.twitterId}`} target="blank">
